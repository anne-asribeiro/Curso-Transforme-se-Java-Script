package cursojava.orientacaoobjetos.atividade4;
...
public class Data {
    ...
    public Data(int dia, int mes, int ano) {
        ...
        // Se o mes for fevereiro e for passado um valor di dia maior que 29 o que é
        // inválido para o mês eu lanço uma exceção
        if (mes == 2) {
            if (dia > 29)
